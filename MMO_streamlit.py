...
st.image("https://images.squarespace-cdn.com/content/5c9e3048523958515c382443/2129c340-d177-48e6-8b14-3c8b01a94ec7/CreamLogo-EMAILSIGNATURE.png?content-type=image%2Fpng")
st.text("")
...
col1, col2 = st.columns(2)
weights = {
    "Short-Term ROI": col1.slider("Short-Term ROI 	:pound:", min_value=0.0, max_value=1.0, value=0.1),
    "Full ROI": col1.slider("Full ROI :moneybag:", min_value=0.0, max_value=1.0, value=0.4),
